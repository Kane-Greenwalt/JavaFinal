	...
	public static void StayPutGame()
	{
		...
		int score = 0;
	     ...
	     if(decides.equals("PLAY"))
	     {
			...
			if(asnwerLine.equalsIgnoreCase("EVEN") && computer == 1||asnwerLine.equalsIgnoreCase("EVEN") && computer == 3)//EvenLose
	    	 {
	    	...
	    	if(asnwerLine.equalsIgnoreCase("EVEN") && computer == 2 ||asnwerLine.equalsIgnoreCase("EVEN") && computer == 4)//EvenWin
	    	{
	    		score++;
	    	...
	    	if(asnwerLine.equalsIgnoreCase("ODDS") && computer == 2||asnwerLine.equalsIgnoreCase("ODD") && computer == 4)//OddLose
	    	{
	    		System.out.println("The answer was even. HAHAHAHA You lose. You have " + score + " points.");
	    		System.out.println("Would you like to play again? YES or NO");
	    	}
	    	
	    	if(asnwerLine.equalsIgnoreCase("ODDS") && computer == 1||asnwerLine.equalsIgnoreCase("ODD") && computer == 3)//OddWin
	    	{
	    		score++;
	         ...
	         decides = input1.nextLine();
		 }while(decides.equalsIgnoreCase("YES"));
