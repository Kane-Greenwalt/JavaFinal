         ...
         if(input.equalsIgnoreCase("YES"))
         {
        	 ...
        	 if(input.equalsIgnoreCase("LEFT"))
        	 {
        		...
        		if(input.equalsIgnoreCase("LEFT"))
        		{
    				...
    				System.out.println("***************************************************");
    				System.out.println("Chad do you really got to mess with the guy?");
        			input = input1.nextLine();
        			...
        			else//passwordFail
        			{
        				...
        				System.out.println("Chad's heart is racing. Chad can see that Eric door is open. He stops out side of Erics office to think for a moment");
        				...
        				if(input.equalsIgnoreCase("TELL"))//EricOfficeTellChoice
        				{
        					...
        					System.out.println("Chad peaks up in curiosity.");
        					System.out.println("it's my job to know these things. You are unmotivated.");
        					System.out.println("Chad shakes his head.");
        					System.out.println("Eric listen.");
        					System.out.println("Eric says: Who said that.");
        					System.out.println("Ummm, national geographic.");
        					System.out.println("Really?");
        					System.out.println("Sure");
        					System.out.println("It's ok. I wont tell the boss.");
        					System.out.println("Eric he's not unmotivated!!");
        					System.out.println("All you have to do is believe you can, and you will. Just look at this poster. Eric says looking right at Chad ingnoring the voice.");
        					...
        					System.out.println("Chad closed his eyes and believed real hard.");
             ...
             if(input.equalsIgnoreCase("Turn Around"))//NicksOffice
        	 {
                        ...
                        
        		 {
        			 System.out.println("Chad turns around and goes towards the mail room where Nick works. Nick");
        		        	 System.out.println("hates his job here at the office. Nick has been working here for 5 years and is still an intern");
        		        	 System.out.println("at the office. Nick sees that Chad has entered the room. Chad started out as an intern at the office");
        		        	 System.out.println("along side of Nick, but Chad isn't an intern. This causes tension between Chad and Nick");
        		        		 ...
        		        		 System.out.println("You know my wife left me..... Nick says with his face still in his hands.");
        		        		 System.out.println("All because I can't get out of here.");
        		        		 System.out.println("Nick starts to sob really bad.");
        		        		 System.out.println("This guy is just sad.");
        		        		 System.out.println("Nick looks up and screams: Shut up asswhole. I don't care that your just a voice in my head.");
        		        		 System.out.println("I guess this guy doesn't get the concept of a narrator");
        		        		 System.out.println("Wait, so you not in my head?");
        		        		 System.out.println("The narrator whispers to Chad, I've put a speaker in his office just so I could play the seinfeld theme song all day.");
        		        		 System.out.println("Nick yells: Just leave you prick");
        		        		 System.out.println("Chad starts to walk out Nick's door.");
        		        		 System.out.println("By the way, Mary says hi.");
        		        		 System.out.println("Nick starts crying again.");
